...
float motor_left_speed = 5;
float motor_right_speed = 5;
/////////////////////////////////////////////////////////////////
   ...
   while(Serial.available() > 0)
    {
       ...
       //Serial.print ("input data process ");
       Serial.println(data);
       Messenger_Handler.process(data);
     
     //Serial.println(Messenger_Handler.process(data));
    } 
...
void Set_Speed()
{
  ...
  motor_right_speed =  5 ;  //Messenger_Handler.readLong();
